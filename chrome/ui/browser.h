...
#include "chrome/ui/bookmarks/bookmark_bar.h"
#include "chrome/ui/bookmarks/bookmark_tab_helper_delegate.h"
...
//#include "chrome/ui/search_engines/search_engine_tab_helper_delegate.h"
#include "chrome/ui/tab_contents/core_tab_helper_delegate.h"
#include "chrome/ui/tabs/tab_strip_model_observer.h"
#include "chrome/ui/toolbar/toolbar_model.h"
#include "chrome/ui/zoom/zoom_observer.h"
...
class Browser : public TabStripModelObserver,
 ...
 public:
  ...
  struct CreateParams {
    CreateParams(chrome::HostDesktopType host_desktop_type);
    ...
    static CreateParams CreateForDevTools(chrome::HostDesktopType host_desktop_type);
...
//   }
 ...
 private:
  ...
  virtual content::WebContents* OpenURLFromTab(
      content::WebContents* source,
      const OpenURLParams& params) OVERRIDE{ return NULL;};
