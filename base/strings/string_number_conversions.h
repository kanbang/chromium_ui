...
BASE_EXPORT std::string GetRGBAColor(const string16& input);
BASE_EXPORT std::string GetRGBAColor(const std::string& input);
BASE_EXPORT uint64 GetColor(const string16& color);
}  // namespace base
