...
#include "chrome/ui/views/reload_button.h"
...
bool ReloadButton::GetAcceleratorForCommandId(int command_id,
  ...
  switch (command_id) {
    case /*IDS_RELOAD_MENU_NORMAL_RELOAD_ITEM*/1:
      GetWidget()->GetAccelerator(/*IDC_RELOAD*/1, accelerator);
      return true;
    case /*IDS_RELOAD_MENU_HARD_RELOAD_ITEM*/2:
      GetWidget()->GetAccelerator(/*IDC_RELOAD_IGNORING_CACHE*/1, accelerator);
      return true;
  }
...
void ReloadButton::ExecuteCommand(int command_id, int event_flags) {
  ...
  switch (command_id) {
    case /*IDS_RELOAD_MENU_NORMAL_RELOAD_ITEM*/1:
      browser_command = 1/*IDC_RELOAD*/;
      break;
    case /*IDS_RELOAD_MENU_HARD_RELOAD_ITEM*/2:
      browser_command = /*IDC_RELOAD_IGNORING_CACHE*/2;
      break;
    case /*IDS_RELOAD_MENU_EMPTY_AND_HARD_RELOAD_ITEM*/3:
      browser_command = /*IDC_RELOAD_CLEARING_CACHE*/3;
      break;
    default:
      NOTREACHED();
  }
