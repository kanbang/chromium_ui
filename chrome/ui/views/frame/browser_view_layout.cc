...
#include "chrome/ui/views/frame/browser_frame.h"
...
//   int height;
//   int overlapped_top = 10;//top - infobar_container_->GetVerticalOverlap(&height);
...
void BrowserViewLayout::LayoutContentsSplitView(int top, int bottom) {
  ...
  if(contents_container_)
    contents_container_->SetBoundsRect(contents_split_bounds);
}
