...
#include "chrome/ui/views/panels/panel_view.h"
...
#include "chrome/ui/panels/panel.h"
#include "chrome/ui/panels/panel_bounds_animation.h"
#include "chrome/ui/panels/panel_manager.h"
#include "chrome/ui/panels/stacked_panel_collection.h"
#include "chrome/ui/views/panels/panel_frame_view.h"
...
#include "chrome/ui/views/panels/taskbar_window_thumbnailer_win.h"
...
// Note: We can't use the acclerator table defined in chrome/ui/views
...
const AcceleratorMapping kPanelAcceleratorMap[] = {
  { ui::VKEY_W, ui::EF_CONTROL_DOWN, /*IDC_CLOSE_WINDOW*/0 },
  { ui::VKEY_W, ui::EF_SHIFT_DOWN | ui::EF_CONTROL_DOWN, /*IDC_CLOSE_WINDOW*/0 },
  { ui::VKEY_F4, ui::EF_ALT_DOWN, /*IDC_CLOSE_WINDOW*/0 },
  { ui::VKEY_R, ui::EF_CONTROL_DOWN, /*IDC_RELOAD*/0 },
  { ui::VKEY_F5, ui::EF_NONE, /*IDC_RELOAD*/0 },
  { ui::VKEY_R, ui::EF_SHIFT_DOWN | ui::EF_CONTROL_DOWN,
      /*IDC_RELOAD_IGNORING_CACHE*/0 },
  { ui::VKEY_F5, ui::EF_CONTROL_DOWN, /*IDC_RELOAD_IGNORING_CACHE*/0 },
  { ui::VKEY_F5, ui::EF_SHIFT_DOWN, /*IDC_RELOAD_IGNORING_CACHE*/0 },
  { ui::VKEY_ESCAPE, ui::EF_NONE, /*IDC_STOP*/0 },
  { ui::VKEY_OEM_MINUS, ui::EF_CONTROL_DOWN, /*IDC_ZOOM_MINUS*/0 },
  { ui::VKEY_SUBTRACT, ui::EF_CONTROL_DOWN, /*IDC_ZOOM_MINUS*/0 },
  { ui::VKEY_0, ui::EF_CONTROL_DOWN, /*IDC_ZOOM_NORMAL*/0 },
  { ui::VKEY_NUMPAD0, ui::EF_CONTROL_DOWN, /*IDC_ZOOM_NORMAL*/0 },
  { ui::VKEY_OEM_PLUS, ui::EF_CONTROL_DOWN, /*IDC_ZOOM_PLUS*/0 },
  { ui::VKEY_ADD, ui::EF_CONTROL_DOWN, /*IDC_ZOOM_PLUS*/0 },
  { ui::VKEY_I, ui::EF_SHIFT_DOWN | ui::EF_CONTROL_DOWN, /*IDC_DEV_TOOLS*/0 },
  { ui::VKEY_J, ui::EF_SHIFT_DOWN | ui::EF_CONTROL_DOWN,
    /*IDC_DEV_TOOLS_CONSOLE*/0 },
};
...
string16 PanelView::GetWindowTitle() const {
  return L"";//panel_->GetWindowTitle();
}
...
gfx::Size PanelView::GetMinimumSize() {
  ...
  return gfx::Size(panel::kPanelMinWidth, panel::kPanelMinHeight);
}
...
bool PanelView::AcceleratorPressed(const ui::Accelerator& accelerator) {
  ...
  return false;//panel_->ExecuteCommandIfEnabled(iter->second);
}
