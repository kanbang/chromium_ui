...
#include "chrome/ui/fullscreen/fullscreen_exit_bubble.h"
...
string16 FullscreenExitBubble::GetCurrentMessageText() const {
  return L"todo";/*fullscreen_bubble::GetLabelTextForType(
...
string16 FullscreenExitBubble::GetAllowButtonText() const {
  return L"todo";//l10n_util::GetStringUTF16(IDS_FULLSCREEN_ALLOW);
}

string16 FullscreenExitBubble::GetInstructionText() const {
  return L"todo";/*l10n_util::GetStringFUTF16(IDS_FULLSCREEN_PRESS_ESC_TO_EXIT,
