...
void OneClickSigninBubbleView::InitDialogContent(views::GridLayout* layout) {
...

  {
    ...
    views::Label* label = new views::Label(
        l10n_util::GetStringUTF16(/*IDS_ONE_CLICK_SIGNIN_DIALOG_TITLE_NEW*/0));
    label->SetHorizontalAlignment(gfx::ALIGN_LEFT);
...

  {
    ...
    views::Label* label = new views::Label(
        l10n_util::GetStringFUTF16(/*IDS_ONE_CLICK_SIGNIN_DIALOG_MESSAGE_NEW*/0,
                                   email_));
    label->SetMultiLine(true);
    label->SetHorizontalAlignment(gfx::ALIGN_LEFT);
  ...
  *ok_button = new views::LabelButton(this, string16());
  ...
  if (is_sync_dialog_) {
    *undo_button = new views::LabelButton(this, string16());
    ...
    ok_label = l10n_util::GetStringUTF16(/*IDS_ONE_CLICK_SIGNIN_DIALOG_OK_BUTTON*/0);
    string16 undo_label =
        l10n_util::GetStringUTF16(/*IDS_ONE_CLICK_SIGNIN_DIALOG_UNDO_BUTTON*/0);
...
void OneClickSigninBubbleView::InitAdvancedLink() {
  advanced_link_ = new views::Link(
      l10n_util::GetStringUTF16(/*IDS_ONE_CLICK_SIGNIN_DIALOG_ADVANCED*/0));
...
void OneClickSigninBubbleView::InitLearnMoreLink() {
  learn_more_link_ = new views::Link(
      l10n_util::GetStringUTF16(/*IDS_LEARN_MORE*/0));
