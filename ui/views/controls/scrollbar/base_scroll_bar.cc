...
string16 BaseScrollBar::GetLabel(int id) const {
  ...
  switch (id) {
    case ScrollBarContextMenuCommand_ScrollHere:
      ids_value = /*IDS_APP_SCROLLBAR_CXMENU_SCROLLHERE*/0;
      break;
    case ScrollBarContextMenuCommand_ScrollStart:
      ids_value = IsHorizontal() ? /*IDS_APP_SCROLLBAR_CXMENU_SCROLLLEFTEDGE*/0
                                 : /*IDS_APP_SCROLLBAR_CXMENU_SCROLLHOME*/0;
      break;
    case ScrollBarContextMenuCommand_ScrollEnd:
      ids_value = IsHorizontal() ? /*IDS_APP_SCROLLBAR_CXMENU_SCROLLRIGHTEDGE*/0
                                 : /*IDS_APP_SCROLLBAR_CXMENU_SCROLLEND*/0;
      break;
    case ScrollBarContextMenuCommand_ScrollPageUp:
      ids_value = /*IDS_APP_SCROLLBAR_CXMENU_SCROLLPAGEUP*/0;
      break;
    case ScrollBarContextMenuCommand_ScrollPageDown:
      ids_value = /*IDS_APP_SCROLLBAR_CXMENU_SCROLLPAGEDOWN*/0;
      break;
    case ScrollBarContextMenuCommand_ScrollPrev:
      ids_value = IsHorizontal() ? /*IDS_APP_SCROLLBAR_CXMENU_SCROLLLEFT*/0
                                 : /*IDS_APP_SCROLLBAR_CXMENU_SCROLLUP*/0;
      break;
    case ScrollBarContextMenuCommand_ScrollNext:
      ids_value = IsHorizontal() ? /*IDS_APP_SCROLLBAR_CXMENU_SCROLLRIGHT*/0
                                 : /*IDS_APP_SCROLLBAR_CXMENU_SCROLLDOWN*/0;
      break;
    default:
