...
void ZoomBubbleView::Refresh() {
  ...
  label_->SetText(
      l10n_util::GetStringFUTF16Int(/*IDS_TOOLTIP_ZOOM*/0, zoom_percent));
...
void ZoomBubbleView::Init() {
  ...
  label_ = new views::Label(
      l10n_util::GetStringFUTF16Int(0/*IDS_TOOLTIP_ZOOM*/, zoom_percent));
  label_->SetFont(
      ResourceBundle::GetSharedInstance().GetFont(ResourceBundle::MediumFont));
  AddChildView(label_);

  views::LabelButton* set_default_button = new views::LabelButton(
      this, l10n_util::GetStringUTF16(/*IDS_ZOOM_SET_DEFAULT*/0));
