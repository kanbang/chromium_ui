...
//#include "chrome/ui/content_settings/content_setting_bubble_model.h"
//#include "chrome/ui/content_settings/content_setting_image_model.h"
#include "chrome/ui/views/content_setting_bubble_contents.h"
...
namespace {
  const int kBackgroundImages[] = {0, 0, 0, 0, 0, 0, 0, 0, 0};//IMAGE_GRID(IDR_OMNIBOX_CONTENT_SETTING_BUBBLE);
