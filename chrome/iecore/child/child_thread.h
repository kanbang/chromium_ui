...
#include "chrome/iecore/trident/WebBrowserHost/XWnd.h"
class RenderView;
...
class ChildThread : public IPC::Listener, public IPC::Sender, public XWnd {
 public:
  // Creates the thread.
  ChildThread();
  ...
  void AddRenderViewRoute(int routing_id, RenderView* rv);
  void RemoveRenderViewRoute(int routing_id);
...
//   }
 ...
 protected:
  ...
  // browser====>childthread
  void Browser_OnNewWindow(Browser_NewWindow_Params* params);
  void Browser_OnReady(const Browser_Ready_Params& params);
 ...
 private:
  ...
  RenderView *m_pBack;
  IDMap<RenderView> render_view_routes_;
