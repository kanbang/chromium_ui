...
#include "chrome/ui/views/bookmarks/bookmark_bar_instructions_view.h"
#include "chrome/ui/views/bookmarks/bookmark_context_menu.h"
#include "chrome/ui/views/bookmarks/bookmark_drag_drop_views.h"
#include "chrome/ui/views/bookmarks/bookmark_menu_controller_views.h"
#include "chrome/ui/views/event_utils.h"
...
class BookmarkBarView::ButtonSeparatorView : public views::View {
 public:
  ...
  virtual void GetAccessibleState(ui::AccessibleViewState* state) OVERRIDE {
    state->name = l10n_util::GetStringUTF16(/*IDS_ACCNAME_SEPARATOR*/0);
...
//         prefs::kAcceptLanguages);
    string16 elided_url(L""/*urlgfx::ElideUrl(url, tt_fonts, max_width, languages)*/);
...
gfx::Size BookmarkBarView::LayoutItems(bool compute_bounds_only) {
  ...
  int x = kLeftMargin;
  int top_margin = /*IsDetached()*/0 ? kDetachedTopMargin : 0;
  int y = top_margin;
