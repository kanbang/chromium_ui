...
GFX_EXPORT HRGN GetHRGNFromImageSkia(const ImageSkia& Image, Size sz);
...
GFX_EXPORT HBITMAP CreateHBITMAPFromSkBitmap(const SkBitmap& sk_bitmap);

GFX_EXPORT SkBitmap* CopyAlphaChannel(const ImageSkia& ImageDest, const ImageSkia& imageSrc);
