...
#include "chrome/ui/panels/panel_constants.h"
#include "chrome/ui/views/panels/panel_view.h"
#include "chrome/ui/views/tab_icon_view.h"
...
void PanelFrameView::Init() {
  ...
  close_button_->SetImage(views::CustomButton::STATE_NORMAL,
                          rb.GetImageSkiaNamed(/*IDR_PANEL_CLOSE*/0));
  close_button_->SetImage(views::CustomButton::STATE_HOVERED,
                          rb.GetImageSkiaNamed(/*IDR_PANEL_CLOSE_H*/0));
  close_button_->SetImage(views::CustomButton::STATE_PRESSED,
                          rb.GetImageSkiaNamed(/*IDR_PANEL_CLOSE_C*/0));
  close_button_->SetImageAlignment(views::ImageButton::ALIGN_CENTER,
                                   views::ImageButton::ALIGN_MIDDLE);
  string16 tooltip_text = l10n_util::GetStringUTF16(/*IDS_PANEL_CLOSE_TOOLTIP*/0);
  close_button_->SetTooltipText(tooltip_text);
  AddChildView(close_button_);

  minimize_button_ = new views::ImageButton(this);
  minimize_button_->SetImage(views::CustomButton::STATE_NORMAL,
                             rb.GetImageSkiaNamed(/*IDR_PANEL_MINIMIZE*/0));
  minimize_button_->SetImage(views::CustomButton::STATE_HOVERED,
                             rb.GetImageSkiaNamed(/*IDR_PANEL_MINIMIZE_H*/0));
  minimize_button_->SetImage(views::CustomButton::STATE_PRESSED,
                             rb.GetImageSkiaNamed(/*IDR_PANEL_MINIMIZE_C*/0));
  tooltip_text = l10n_util::GetStringUTF16(/*IDS_PANEL_MINIMIZE_TOOLTIP*/0);
  ...
  restore_button_->SetImage(views::CustomButton::STATE_NORMAL,
                            rb.GetImageSkiaNamed(/*IDR_PANEL_RESTORE*/0));
  restore_button_->SetImage(views::CustomButton::STATE_HOVERED,
                            rb.GetImageSkiaNamed(/*IDR_PANEL_RESTORE_H*/0));
  restore_button_->SetImage(views::CustomButton::STATE_PRESSED,
                            rb.GetImageSkiaNamed(/*IDR_PANEL_RESTORE_C*/0));
  restore_button_->SetImageAlignment(views::ImageButton::ALIGN_CENTER,
                                     views::ImageButton::ALIGN_MIDDLE);
  tooltip_text = l10n_util::GetStringUTF16(/*IDS_PANEL_RESTORE_TOOLTIP*/0);
  ...
  title_label_ = new views::Label(/*panel_view_->panel()->GetWindowTitle()*/L"title");
...
void PanelFrameView::UpdateWindowTitle() {
  title_label_->SetText(/*panel_view_->panel()->GetWindowTitle()*/L"dadas");
}
