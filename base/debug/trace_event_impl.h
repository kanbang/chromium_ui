...
class BASE_EXPORT TraceLog {
 ...
 private:
  ...
  base::unordered_map<int, std::string> process_labels_;
  int process_sort_index_;
  base::unordered_map<int, int> thread_sort_indices_;
  base::unordered_map<int, std::string> thread_names_;

  // The following two maps are used only when ECHO_TO_CONSOLE.
  base::unordered_map<int, std::stack<TimeTicks> > thread_event_start_times_;
  base::unordered_map<std::string, int> thread_colors_;
  ...
  unordered_set<MessageLoop*> thread_message_loops_;
