...
std::string GetStringFUTF8(int message_id,
                           const string16& a) {
  return "";//return UTF16ToUTF8(GetStringFUTF16(message_id, a));
}

std::string GetStringFUTF8(int message_id,
                           const string16& a,
                           const string16& b) {
  return "";//return UTF16ToUTF8(GetStringFUTF16(message_id, a, b));
}
...
std::string GetStringFUTF8(int message_id,
                           ...
                           const string16& b,
                           const string16& c) {
  return "";//return UTF16ToUTF8(GetStringFUTF16(message_id, a, b, c));
}
...
std::string GetStringFUTF8(int message_id,
                           ...
                           const string16& c,
                           const string16& d) {
  return "";//return UTF16ToUTF8(GetStringFUTF16(message_id, a, b, c, d));
}
...
string16 GetStringFUTF16(int message_id,
                         const string16& a,
                         const string16& b) {
  return L"";//GetStringFUTF16(message_id, a, b, NULL);
}
