...
void SetFontAndTextDirection(base::DictionaryValue* localized_strings) {
  int web_font_family_id = /*IDS_WEB_FONT_FAMILY*/0;
  int web_font_size_id = /*IDS_WEB_FONT_SIZE*/0;
#if defined(OS_WIN)
  // Vary font settings for Windows XP.
  if (base::win::GetVersion() < base::win::VERSION_VISTA) {
    web_font_family_id = /*IDS_WEB_FONT_FAMILY_XP*/0;
    web_font_size_id = /*IDS_WEB_FONT_SIZE_XP*/0;
  }
#endif
