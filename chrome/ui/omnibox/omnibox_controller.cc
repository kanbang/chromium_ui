...
OmniboxController::OmniboxController(OmniboxEditModel* omnibox_edit_model, Profile* profile)
    : omnibox_edit_model_(omnibox_edit_model),profile_(profile),
...
void OmniboxController::OnResultChanged(bool default_match_changed) {
  ...
  if (default_match_changed) {
    ...
    if (match != result.end()) {
      ...
      if (omnibox_edit_model_->GetInstantController()) {
