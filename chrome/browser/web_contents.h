...
// for more details.
class CONTENT_EXPORT WebContents : public base::SupportsUserData {
 public:
...
//   static WebContents* CreateWithSessionStorage(
...
//       const SessionStorageNamespaceMap& session_storage_namespace_map);
  ...
  static WebContents* FromRenderViewHost(
...
//                                const PageState& page_state)= 0;
  ...
  // NavigateUrl..
  virtual void NavigateUrl(const GURL& url) = 0;
