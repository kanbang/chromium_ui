...
BASE_EXPORT std::vector<string16> split_text(
                                              const string16 &text,
                                              const string16 &split_string,
                                              bool skip_empty = true);

BASE_EXPORT string16 trim(const string16 &text);

BASE_EXPORT int compare(const string16 &a, const string16 &b, bool case_insensitive);
BASE_EXPORT int compare(const std::string &a, const std::string &b, bool case_insensitive);
