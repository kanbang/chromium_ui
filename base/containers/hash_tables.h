...
namespace base {
using BASE_HASH_NAMESPACE::unordered_map;
using BASE_HASH_NAMESPACE::unordered_multimap;
using BASE_HASH_NAMESPACE::unordered_multiset;
using BASE_HASH_NAMESPACE::unordered_set;
