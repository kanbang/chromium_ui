...
//                               int flags);
  ...
  void DrawImageByStretchLine(const gfx::ImageSkia& image,
    int dst_x, int dst_y, int dst_w, int dst_h, int s = 0, int t = 1);
  void DrawImageByStretchPoint(const gfx::ImageSkia& image,
