...
class VIEWS_EXPORT Background {
 public:
  ...
  static Background* CreateImageBackground();
  static Background* CreateImageBackground(int id, int state, int index);
  ...
  virtual void Paint(gfx::Canvas* canvas, View* view) = 0;
