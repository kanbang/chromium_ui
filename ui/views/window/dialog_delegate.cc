...
base::string16 DialogDelegate::GetDialogButtonLabel(
  ...
  if (button == ui::DIALOG_BUTTON_OK)
    return L"ok";/*l10n_util::GetStringUTF16(IDS_APP_OK)*/;
  if (button == ui::DIALOG_BUTTON_CANCEL) {
    if (GetDialogButtons() & ui::DIALOG_BUTTON_OK)
      return L"ok"/*l10n_util::GetStringUTF16(IDS_APP_CANCEL)*/;
    return L"close"/*l10n_util::GetStringUTF16(IDS_APP_CLOSE)*/;
  }
  NOTREACHED();
  return base::string16();
}
