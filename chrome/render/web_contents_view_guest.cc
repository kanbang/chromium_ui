...
#include "chrome/render/web_contents_view_guest.h"
...
WebContentsViewGuest::WebContentsViewGuest(
    ...
    : web_contents_(web_contents),
      ...
      /*platform_view_delegate_view_(NULLplatform_view_delegate_view)*/ {
}
...
gfx::NativeWindow WebContentsViewGuest::GetTopLevelNativeWindow() const {
  return NULL;//guest_->embedder_web_contents()->GetView()->GetTopLevelNativeWindow();
}
...
RenderWidgetHostView* WebContentsViewGuest::CreateViewForPopupWidget(
    RenderWidgetHost* render_widget_host) {
  return NULL;//RenderWidgetHostViewPort::CreateViewForWidget(render_widget_host);
}
