...
// #endif
  ...
  RenderFrameHostImpl* main_render_frame_host() const {
    return NULL;//main_render_frame_host_.get();
  }

  void OnCreateNewWindow(int browserid);
  void OnUrlChange(int pageid, const string16& url);
  void OnTitleChange(int pageid, const string16& title);
  void OnGotFocus();
