...
#include "chrome/ui/views/bookmarks/bookmark_menu_delegate.h"
#include "chrome/ui/views/wrench_menu_observer.h"
...
MenuItemView* WrenchMenu::AddMenuItem(MenuItemView* parent,
  ...
  if (command_id > -1) {  // Don't add separators to |command_id_to_entry_|.
    ...
    if (command_id != /*IDC_SHOW_HISTORY*/0) {
