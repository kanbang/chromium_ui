...
#include "chrome/ui/omnibox/location_bar_util.h"
...
#include "chrome/ui/views/bookmarks/bookmark_prompt_view.h"
#include "chrome/ui/views/browser_dialogs.h"
//#include "chrome/ui/views/extensions/extension_popup.h"
#include "chrome/ui/views/location_bar/content_setting_image_view.h"
#include "chrome/ui/views/location_bar/ev_bubble_view.h"
#include "chrome/ui/views/location_bar/generated_credit_card_view.h"
#include "chrome/ui/views/location_bar/keyword_hint_view.h"
#include "chrome/ui/views/location_bar/location_bar_layout.h"
#include "chrome/ui/views/location_bar/location_icon_view.h"
#include "chrome/ui/views/location_bar/open_pdf_in_reader_view.h"
//#include "chrome/ui/views/location_bar/page_action_image_view.h"
//#include "chrome/ui/views/location_bar/page_action_with_badge_view.h"
#include "chrome/ui/views/location_bar/script_bubble_icon_view.h"
#include "chrome/ui/views/location_bar/selected_keyword_view.h"
#include "chrome/ui/views/location_bar/star_view.h"
#include "chrome/ui/views/location_bar/zoom_bubble_view.h"
#include "chrome/ui/views/location_bar/zoom_view.h"
...
#include "chrome/ui/views/first_run_bubble.h"
#endif
...
Browser* GetBrowserFromDelegate(LocationBarView::Delegate* delegate) {
  ...
  return NULL;//contents ? chrome::FindBrowserWithWebContents(contents) : NULL;
}
...
void LocationBarView::Init() {
  ...
  const int desired_font_size = 16;//browser_defaults::kOmniboxFontPixelSize;
...
void LocationBarView::Layout() {
  ...
  const int kEditLeadingInternalSpace =
      (0 || GetOmniboxViewWin(location_entry_.get())) ? 1 : 0;
...
void LocationBarView::Update(const WebContents* contents) {
  ...
  bool star_enabled = !is_popup_mode_ &&
...
void LocationBarView::GetAccessibleState(ui::AccessibleViewState* state) {
  ...
  state->name = l10n_util::GetStringUTF16(/*IDS_ACCNAME_LOCATION*/0);
...
void LocationBarView::PaintPageActionBackgrounds(gfx::Canvas* canvas) {
  ...
  const int32 tab_id = 0;//SessionID::IdForTab(web_contents);
