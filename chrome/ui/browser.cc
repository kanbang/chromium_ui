...
//#include "chrome/ui/app_modal_dialogs/javascript_dialog_manager.h"
//#include "chrome/ui/autofill/tab_autofill_manager_delegate.h"
//#include "chrome/ui/blocked_content/popup_blocker_tab_helper.h"
...
#include "chrome/ui/browser_content_setting_bubble_model_delegate.h"
//#include "chrome/ui/browser_dialogs.h"
#include "chrome/ui/browser_finder.h"
//#include "chrome/ui/browser_instant_controller.h"
...
#include "chrome/ui/browser_tab_contents.h"
#include "chrome/ui/browser_tab_restore_service_delegate.h"
#include "chrome/ui/browser_tab_strip_model_delegate.h"
#include "chrome/ui/browser_tabstrip.h"
#include "chrome/ui/browser_toolbar_model_delegate.h"
#include "chrome/ui/browser_ui_prefs.h"
#include "chrome/ui/browser_window.h"
//#include "chrome/ui/chrome_pages.h"
//#include "chrome/ui/chrome_select_file_policy.h"
//#include "chrome/ui/fast_unload_controller.h"
#include "chrome/ui/find_bar/find_bar.h"
#include "chrome/ui/find_bar/find_bar_controller.h"
#include "chrome/ui/find_bar/find_tab_helper.h"
#include "chrome/ui/fullscreen/fullscreen_controller.h"
//#include "chrome/ui/global_error/global_error.h"
//#include "chrome/ui/global_error/global_error_service.h"
//#include "chrome/ui/global_error/global_error_service_factory.h"
//#include "chrome/ui/media_utils.h"
...
//#include "chrome/ui/search_engines/search_engine_tab_helper.h"
//#include "chrome/ui/singleton_tabs.h"
#include "chrome/ui/status_bubble.h"
//#include "chrome/ui/sync/browser_synced_window_delegate.h"
#include "chrome/ui/tab_contents/core_tab_helper.h"
//#include "chrome/ui/tab_modal_confirm_dialog.h"
#include "chrome/ui/tabs/dock_info.h"
#include "chrome/ui/tabs/tab_menu_model.h"
#include "chrome/ui/tabs/tab_strip_model.h"
#include "chrome/ui/toolbar/toolbar_model_impl.h"
//#include "chrome/ui/unload_controller.h"
//#include "chrome/ui/web_applications/web_app_ui.h"
//#include "chrome/ui/webui/signin/login_ui_service.h"
//#include "chrome/ui/webui/signin/login_ui_service_factory.h"
//#include "chrome/ui/window_sizer/window_sizer.h"
#include "chrome/ui/zoom/zoom_controller.h"
...
Browser::CreateParams::CreateParams(chrome::HostDesktopType host_desktop_type)
    : type(TYPE_TABBED),
...
Browser::CreateParams Browser::CreateParams::CreateForApp(
  ...
  CreateParams params(type, host_desktop_type);
...
Browser::CreateParams Browser::CreateParams::CreateForDevTools(
    chrome::HostDesktopType host_desktop_type) {
  CreateParams params(TYPE_POPUP, host_desktop_type);
  params.app_name = "todo dev";//DevToolsWindow::kDevToolsApp;
  return params;
}
...
bool Browser::is_devtools() const {
  return app_name_ == "todo : dev";//DevToolsWindow::kDevToolsApp;
}
...
//     return DOWNLOAD_CLOSE_OK;
  ...
  int total_download_count = 0;//DownloadService::DownloadCountAllProfiles();
...
//     tab_strip_model_->GetActiveWebContents()));
// 
//   base::FilePath directory;// = profile_->last_selected_directory();
// 
...
bool Browser::CanReloadContents(content::WebContents* web_contents) const {
  return false;//chrome::CanReload(this);
}

bool Browser::CanSaveContents(content::WebContents* web_contents) const {
  return false;//chrome::CanSavePage(this);
}
