...
base::string16 Accelerator::GetShortcutText() const {
  ...
  switch (key_code_) {
    case ui::VKEY_TAB:
      string_id = /*IDS_APP_TAB_KEY*/0;
      break;
    case ui::VKEY_RETURN:
      string_id = /*IDS_APP_ENTER_KEY*/0;
      break;
    case ui::VKEY_ESCAPE:
      string_id = /*IDS_APP_ESC_KEY*/0;
      break;
    case ui::VKEY_PRIOR:
      string_id = /*IDS_APP_PAGEUP_KEY*/0;
      break;
    case ui::VKEY_NEXT:
      string_id = /*IDS_APP_PAGEDOWN_KEY*/0;
      break;
    case ui::VKEY_END:
      string_id = /*IDS_APP_END_KEY*/0;
      break;
    case ui::VKEY_HOME:
      string_id = /*IDS_APP_HOME_KEY*/0;
      break;
    case ui::VKEY_INSERT:
      string_id = /*IDS_APP_INSERT_KEY*/0;
      break;
    case ui::VKEY_DELETE:
      string_id = /*IDS_APP_DELETE_KEY*/0;
      break;
    case ui::VKEY_LEFT:
      string_id = /*IDS_APP_LEFT_ARROW_KEY*/0;
      break;
    case ui::VKEY_RIGHT:
      string_id = /*IDS_APP_RIGHT_ARROW_KEY*/0;
      break;
    case ui::VKEY_UP:
      string_id = /*IDS_APP_UP_ARROW_KEY*/0;
      break;
    case ui::VKEY_DOWN:
      string_id = /*IDS_APP_DOWN_ARROW_KEY*/0;
      break;
    case ui::VKEY_BACK:
      string_id = /*IDS_APP_BACKSPACE_KEY*/0;
      break;
    case ui::VKEY_F1:
      string_id = /*IDS_APP_F1_KEY*/0;
      break;
    case ui::VKEY_F11:
      string_id = /*IDS_APP_F11_KEY*/0;
      break;
    case ui::VKEY_OEM_COMMA:
      string_id = /*IDS_APP_COMMA_KEY*/0;
      break;
    case ui::VKEY_OEM_PERIOD:
      string_id = /*IDS_APP_PERIOD_KEY*/0;
      break;
    case ui::VKEY_MEDIA_NEXT_TRACK:
      string_id = /*IDS_APP_MEDIA_NEXT_TRACK_KEY*/0;
      break;
    case ui::VKEY_MEDIA_PLAY_PAUSE:
      string_id = /*IDS_APP_MEDIA_PLAY_PAUSE_KEY*/0;
      break;
    case ui::VKEY_MEDIA_PREV_TRACK:
      string_id = /*IDS_APP_MEDIA_PREV_TRACK_KEY*/0;
      break;
    case ui::VKEY_MEDIA_STOP:
      string_id = /*IDS_APP_MEDIA_STOP_KEY*/0;
      break;
    default:
      break;
  }
...
//   }
  ...
  if (IsShiftDown())
    shortcut = l10n_util::GetStringFUTF16(/*IDS_APP_SHIFT_MODIFIER*/0, shortcut);

  // Note that we use 'else-if' in order to avoid using Ctrl+Alt as a shortcut.
  // See http://blogs.msdn.com/oldnewthing/archive/2004/03/29/101121.aspx for
  // more information.
  if (IsCtrlDown())
    shortcut = l10n_util::GetStringFUTF16(/*IDS_APP_CONTROL_MODIFIER*/0, shortcut);
  else if (IsAltDown())
    shortcut = l10n_util::GetStringFUTF16(/*IDS_APP_ALT_MODIFIER*/0, shortcut);

  if (IsCmdDown())
    shortcut = l10n_util::GetStringFUTF16(/*IDS_APP_COMMAND_MODIFIER*/0, shortcut);
