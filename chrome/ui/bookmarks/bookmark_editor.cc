...
#include "chrome/ui/bookmarks/bookmark_editor.h"
...
BookmarkEditor::EditDetails::EditDetails(Type node_type)
    : type(node_type),index(-1) {
}

int BookmarkEditor::EditDetails::GetNodeType() const {
...
int BookmarkEditor::EditDetails::GetWindowTitleId() const {
  int dialog_title = 0;//IDS_BOOKMARK_EDITOR_TITLE;
//   switch (type) {
