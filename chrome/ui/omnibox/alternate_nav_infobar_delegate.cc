...
#include "chrome/ui/omnibox/alternate_nav_infobar_delegate.h"
...
// static
void AlternateNavInfoBarDelegate::Create(const GURL& alternate_nav_url) {
  //infobar_service->AddInfoBar(scoped_ptr<InfoBarDelegate>(
  //    new AlternateNavInfoBarDelegate(infobar_service, alternate_nav_url)));
}

AlternateNavInfoBarDelegate::AlternateNavInfoBarDelegate(const GURL& alternate_nav_url)
...
string16 AlternateNavInfoBarDelegate::GetMessageTextWithOffset(
  ...
  const string16 label = L"";/*l10n_util::GetStringFUTF16(
...
//   return 0;//IDR_INFOBAR_ALT_NAV_URL;
// }
