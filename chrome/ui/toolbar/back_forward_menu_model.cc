...
#include "chrome/ui/toolbar/back_forward_menu_model.h"
...
// #endif
  ...
  return L"todo menutext";//menu_text;
}
...
string16 BackForwardMenuModel::GetShowFullHistoryLabel() const {
  return L"todo Hislabel";//l10n_util::GetStringUTF16(IDS_SHOWFULLHISTORY_LINK);
}
