...
#include "chrome/ui/tab_contents/chrome_web_contents_view_delegate.h"
#include "chrome/ui/views/sad_tab_view.h"
//#include "chrome/ui/views/tab_contents/render_view_context_menu_views.h"
...
#endif
  return NULL;//bookmark_handler_.get();
}
